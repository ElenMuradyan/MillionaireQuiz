            ...
            <Flex align="center" justify="center" vertical>
                ...
                {language === 'en' ? `Hi ${userProfileInfo.firstName}. Step into the world of high-stakes trivia with the Millionaire Quiz Game! 
                    ...
                    Play now and see how far your knowledge can take you!` : 
                     `Բարև ${userProfileInfo.firstName} Միլիոնատեր Վիկտորինայի խաղում! Տվեք մի քանի հարցերի ճիշտ պատասխաններ և հաղթեք վիրտուալ միլիոններ: Կկարողանաք հաղթել և դառնալ միլիոնատեր? Աշխատեք հիմա և բացահայտեք, թե որքան հեռու կարող եք հասնել ձեր գիտելիքներով:`}
